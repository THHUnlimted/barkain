...
> Last updated: 2026-04-23 (v3.8 — 3g-B-fix-1 (#55) wires `portalMembershipsSection` into `ProfileView`'s second `ScrollView` branch so completed-profile users see the new toggles)
>
