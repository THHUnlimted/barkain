...
private final class PreviewCardAPIClient: BarePreviewAPIClient, @unchecked Sendable {
    override func getCardCatalog() async throws -> [CardRewardProgram] {
        [
            CardRewardProgram(
    ...
    override func addCard(_ request: AddCardRequest) async throws -> UserCardSummary {
        UserCardSummary(
