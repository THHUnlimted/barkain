#!/usr/bin/env bash
# eBay (New) extraction — filters to NEW condition items only.
# Search URL includes &LH_ItemCondition=1000 for new items.
#
# Anchor: .s-item or [data-viewport] items
...
# eBay new condition filter: LH_ItemCondition=1000
SEARCH_URL="https://www.ebay.com/sch/i.html?_nkw=$(echo "$QUERY" | sed 's/ /+/g')&LH_ItemCondition=1000"
