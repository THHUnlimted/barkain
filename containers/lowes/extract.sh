#!/usr/bin/env bash
# Lowe's extraction script — standard agent-browser DOM eval pattern.
...
# Site-specific URLs
SITE_HOMEPAGE="https://www.lowes.com"
SEARCH_URL="https://www.lowes.com/search?searchTerm=$(echo "$QUERY" | sed 's/ /+/g')"
