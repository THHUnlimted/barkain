...
2. **Phase 3 — Recommendation Intelligence (IN PROGRESS):** 3a ✅ text search (#22, #23). 3b ✅ eBay Browse API + deletion webhook (#24). 3c ✅ Search v2 (cascade + variant collapse + deep search + eBay affiliate fix, PR #32). Next: 3d M6 Recommendation Engine (Claude Sonnet synthesis), 3e card rewards, 3f portal stacking, 3g image scan, 3h receipts, 3i identity stacking, 3j savings dashboard, 3k coupons, 3l hardening + `v0.3.0`.
