...
> **Last updated:** April 2026 (v4.7 — Step 2g M12 Affiliate Router + in-app browser complete)
...
**Test counts:** 280 backend (280 passed / 6 skipped, +14 in Step 2g: 9 pure URL construction + 3 click/stats + 2 conversion webhook in `test_m12_affiliate.py`), 66 iOS unit (+6 in Step 2g: 3 `ScannerViewModelTests.test_resolveAffiliateURL_*` + 3 `IdentityDiscountCardTests.test_resolvedURL_*`), 0 UI, 0 snapshot.
