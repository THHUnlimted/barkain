...
| thumbnail-coverage-L1 | LOW | Tier 3 Gemini search rows show box-icon placeholder (no image field). **Explicitly deferred** until iOS miss-rate telemetry is in place (no point optimizing what we can't measure) | Phase 3 |
