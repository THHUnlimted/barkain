...
> **Last updated:** April 2026 (v4.4 — Step 2d M5 Identity Profile + discount catalog complete)
...
**Test counts:** 222 backend (222 passed / 6 skipped, +30 in Step 2d: 18 m5_identity + 12 seed-lint), 43 iOS unit (+7 in Step 2d: 4 IdentityOnboardingViewModel + 3 fetchIdentityDiscounts), 0 UI, 0 snapshot.
...
10. **Remaining pre-fixes (not blockers):**
...
11. **Phase 2 continues:** Step 2e (M5 Card Portfolio) or Step 2f (M11 Billing / RevenueCat). Deferred from Step 2d: Amazon Prime Access EBT/Medicaid (no backing profile flag), Samsung partner-employees tier (same), and live-backend XCUITest for the full onboarding → scan → reveal flow.
