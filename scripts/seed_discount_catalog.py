...
BRAND_RETAILERS: list[dict] = [
    ...
    # Benefits Expansion: 4 student-tech brand-direct retailers. Not scraped —
    # identity-discount redirect targets only (extraction_method='none').
    {
        "id": "acer_direct",
        "display_name": "Acer Education Store",
        "base_url": "https://store.acer.com/en-us",
        "extraction_method": "none",
        "supports_coupons": False,
        "supports_identity": True,
        "supports_portals": False,
    ...
    {
        "id": "asus_direct",
        "display_name": "ASUS Education Store",
        "base_url": "https://store.asus.com/us",
        "extraction_method": "none",
        "supports_coupons": False,
        "supports_identity": True,
        "supports_portals": False,
    ...
    {
        "id": "logitech_direct",
        "display_name": "Logitech Education",
        "base_url": "https://www.logitech.com/en-us",
        "extraction_method": "none",
        "supports_coupons": False,
        "supports_identity": True,
        "supports_portals": False,
...
_PROGRAM_TEMPLATES: list[dict] = [
    ...
    # New brand-direct tech programs targeted at Barkain's student/young-adult
    # audience. Each applies at the brand's own store only; the identity service
    # already scopes samsung/apple/etc. to their retailer-specific price, so
    # percentages compute against the brand's MSRP (or highest scraped price
    # fallback for non-scraped brand-direct retailers — see 3f-hotfix).
    {
        "retailer_id": "apple_direct",
        "program_name": "Apple Education (Student)",
        "program_type": "identity",
        "eligibility_types": ["student"],
        ...
        "verification_url": "https://www.apple.com/us-hed/shop",
        "url": "https://www.apple.com/us-hed/shop",
        "discount_details": "Flat $50–$100 off Mac/iPad. Back-to-School adds free AirPods with Mac. Cannot stack with other Apple promos.",
    },
    {
        "retailer_id": "samsung_direct",
        "program_name": "Samsung Student Pricing",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 30,
        "discount_max_value": 500,
        "verification_method": "unidays",
        "verification_url": "https://www.samsung.com/us/shop/offer-program/students/",
        "url": "https://www.samsung.com/us/shop/offer-program/students/",
        "discount_details": "Up to 30% off Galaxy phones, tablets, laptops. Per-product sale-price rules apply.",
    },
    {
        "retailer_id": "hp_direct",
        "program_name": "HP Education",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 35,
        ...
        "verification_url": "https://www.hp.com/us-en/shop/cv/hp-education",
        "url": "https://www.hp.com/us-en/shop/cv/hp-education",
        "discount_details": "Up to 35% off laptops, desktops, accessories. Cannot stack with HP Frontline Heroes.",
    },
    {
        "retailer_id": "dell_direct",
        "program_name": "Dell University",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 10,
        ...
        "verification_url": "https://www.dell.com/en-us/lp/student",
        "url": "https://www.dell.com/en-us/lp/student",
        "discount_details": "10% off laptops + accessories. Stacks with some sale pricing — check per-SKU.",
    },
    {
        "retailer_id": "lenovo_direct",
        "program_name": "Lenovo Student",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 5,
        ...
        "verification_url": "https://www.lenovo.com/us/en/d/deals/student/",
        "url": "https://www.lenovo.com/us/en/d/deals/student/",
        "discount_details": "Up to 5% off. Stackable with select sale SKUs.",
    },
    {
        "retailer_id": "microsoft_direct",
        "program_name": "Microsoft Education (Surface)",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 10,
        ...
        "verification_url": "https://www.microsoft.com/en-us/store/b/education",
        "url": "https://www.microsoft.com/en-us/store/b/education",
        "discount_details": "10% off Surface devices (laptops, tablets). Cannot stack with Microsoft military.",
    },
    {
        "retailer_id": "acer_direct",
        "program_name": "Acer Education",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 10,
        "discount_max_value": None,
        "verification_method": "id_me",
        "verification_url": "https://store.acer.com/en-us/education",
        "url": "https://store.acer.com/en-us/education",
        "discount_details": "10% off laptops and Chromebooks. Per-SKU exclusions on the education storefront.",
    },
    {
        "retailer_id": "asus_direct",
        "program_name": "ASUS Education",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 10,
        "discount_max_value": None,
        "verification_method": "id_me",
        "verification_url": "https://store.asus.com/us/b2b/education",
        "url": "https://store.asus.com/us/b2b/education",
        "discount_details": "Up to 10% off laptops, including ROG gaming gear.",
    },
    {
        "retailer_id": "razer_direct",
        "program_name": "Razer Educate",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 15,
        "discount_max_value": None,
        "verification_method": "id_me",
        "verification_url": "https://www.razer.com/landingpg/education",
        "url": "https://www.razer.com/landingpg/education",
        "discount_details": "Up to 15% off peripherals, gaming laptops, headsets. Cannot stack with Razer sale pricing.",
    },
    {
        "retailer_id": "logitech_direct",
        "program_name": "Logitech Education",
        "program_type": "identity",
        "eligibility_types": ["student"],
        "discount_type": "percentage",
        "discount_value": 10,
        "discount_max_value": None,
        "verification_method": "id_me",
        "verification_url": "https://www.logitech.com/en-us/promotions/education.html",
        "url": "https://www.logitech.com/en-us/promotions/education.html",
        "discount_details": "Typical 10–20% off peripherals, webcams, headsets (varies by SKU).",
    },
    # MARK: - Benefits Expansion — Young Adult (18–24)
    # Amazon Prime Young Adult: 50 % off the Prime *membership fee* — NOT off
    # products. Matches the 3f-hotfix treatment of Prime Student: scope flips
    # to 'membership_fee' and IdentityService._build automatically nulls out
    # estimated_savings for non-'product' scopes.
    {
        "retailer_id": "amazon",
        "program_name": "Prime Young Adult",
        "program_type": "identity",
        "eligibility_types": ["young_adult"],
        "discount_type": "percentage",
        "discount_value": 50,
        "discount_max_value": None,
        "verification_method": "age_verification",
        "verification_url": "https://www.amazon.com/amazon-prime-young-adult",
        "url": "https://www.amazon.com/amazon-prime-young-adult",
        "discount_details": "50% off Prime membership fee for 18–24 ($7.49/mo after 6-mo free trial). Membership-tier benefit — not per-item savings. Mutually exclusive with Prime Student.",
        "scope": "membership_fee",
    },
]
